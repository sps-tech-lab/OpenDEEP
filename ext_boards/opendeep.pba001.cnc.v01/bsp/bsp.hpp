...
#define PIN_MOSI        11 // SPI1 TX / MOSI / LCD SDA
#define PIN_CS          9  // LCD CS
#define PIN_DC          14 // LCD D/C
#define PIN_RST         12 // LCD RESET
...
// ===== LCD compatibility aliases =====
#define PIN_LCD_SCK      PIN_SCK
#define PIN_LCD_MOSI     PIN_MOSI
#define PIN_LCD_CS       PIN_CS
#define PIN_LCD_DC       PIN_DC
#define PIN_LCD_RST      PIN_RST
#define PIN_LCD_BLK      PIN_BLK
#define PIN_LCD_TE       PIN_TE
