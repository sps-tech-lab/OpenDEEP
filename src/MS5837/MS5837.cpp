...
void PresTempSensor::calculate()
{
    ...
    diff_temp = static_cast<int32_t>(this->raw_temperature
              -(static_cast<uint32_t>(this->calibration[5])*256l));

    actual_temp = 2000l + static_cast<int32_t>((
                  static_cast<int64_t>(diff_temp) * static_cast<uint32_t>(this->calibration[6])) >> 23); //2^23
    ...
    this->compensated_pressure = static_cast<int32_t>((this->raw_pressure*sens_temp_2nd/2097152l-off_temp_2nd)/32768l);
}
...
bool PresTempSensor::read_pressure(MS5837osr osr)
{
    ...
    switch (osr)
    {
        case MS5837osr::osr256:  cmd = MS5837_DP_CONV_256;  break;
        case MS5837osr::osr512:  cmd = MS5837_DP_CONV_512;  break;
        case MS5837osr::osr1024: cmd = MS5837_DP_CONV_1024; break;
        case MS5837osr::osr2048: cmd = MS5837_DP_CONV_2048; break;
        case MS5837osr::osr4096: cmd = MS5837_DP_CONV_4096; break;
        case MS5837osr::osr8192: cmd = MS5837_DP_CONV_8192; break;
    ...
    this->raw_pressure = (static_cast<uint32_t>(this->readbuf[0]) << 16) |
                             (static_cast<uint32_t>(this->readbuf[1]) << 8)  |
                              static_cast<uint32_t>(this->readbuf[2]);
...
bool PresTempSensor::read_temperature(MS5837osr osr)
{
    ...
    switch (osr)
    {
    case MS5837osr::osr256:  cmd = MS5837_DT_CONV_256;  break;
    case MS5837osr::osr512:  cmd = MS5837_DT_CONV_512;  break;
    case MS5837osr::osr1024: cmd = MS5837_DT_CONV_1024; break;
    case MS5837osr::osr2048: cmd = MS5837_DT_CONV_2048; break;
    case MS5837osr::osr4096: cmd = MS5837_DT_CONV_4096; break;
    case MS5837osr::osr8192: cmd = MS5837_DT_CONV_8192; break;
    default: return false;
    }
